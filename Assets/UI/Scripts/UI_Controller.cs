...
public class UI_Controller : MonoBehaviour
{
    ...
    {
        panels.Clear();
        panels.Add(UI_Element.StartMenu, Instance.transform.Find("StartMenu").gameObject);
        panels.Add(UI_Element.Game, Instance.transform.Find("Game").gameObject);
        panels.Add(UI_Element.GameResults, Instance.transform.Find("GameResults").gameObject);
    }
}